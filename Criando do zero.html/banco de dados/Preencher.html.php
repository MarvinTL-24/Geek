...
echo "<body>
    <form action='transferindo.php' method='post'>
        <fieldset>
            <div class='card container mt-3'>
                <div class='mt-2'>
                    <h2 style = 'text-align:center;'class='mt-0'>CADASTRAR INFORAMAÇÕES DE TRABALHO</h2>
                </div>  
                <label>Nome:</label>
                ...
                <input type ='text' name='contato1' required><br>
                <input type ='text' name='contato2'><br>
                <input type ='text' name='contato3'><br>
